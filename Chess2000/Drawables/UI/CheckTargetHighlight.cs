...
{
    public class CheckTargetHighlight : ChessDrawable
    {
        ...
        public CheckTargetHighlight(GraphicsManager graphicsManager, string location) : base(graphicsManager)
        {
            _location = location;
            _texture2D = Content.Load<Texture2D>("UI/Actions/Check");
        }
